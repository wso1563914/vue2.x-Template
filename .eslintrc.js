module.exports = {
    ...
    rules: {
        ...
        'no-console': process.env.NODE_ENV === 'development' ? 0 : 1, //禁止使用console
        'no-debugger': process.env.NODE_ENV === 'development' ? 0 : 1, //禁止使用debugger
        ...
        radix: [2, 'as-needed'], //parseInt必须指定第二个参数
        'id-match': 0, //命名检测
